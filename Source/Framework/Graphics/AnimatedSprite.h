...
namespace GameDev2D
{
    ...
    public:
        ...
        //Overrides the SpriteAtlas' draw method
        void Draw();
        ...
        //Returns wether the Sprite draws the last frame on animation's completion
        bool DoesDrawLastFrameOnCompletion();

        //Sets if the Sprite draws the last frame on animation's completion
        void SetDrawLastFrameOnCompletion(bool drawLastFrameOnCompletion);
        ...
        //Returns wether the animation is paused or not
        bool IsPaused();
    ...
    private:
        ...
        bool m_DoesLoop;
		bool m_Pause;
        bool m_DrawLastFrameOnCompletion;
    };
}
